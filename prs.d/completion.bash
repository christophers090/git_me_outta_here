...
_prs_completions() {
    ...
    # All available flags
    opts="-o --outstanding --this -s --sub --submodule -d --diff -f --files -m --merge -c --comments -csr -cr -crx -ct -ctx -cx -pa -prc --pc --close -w --web -bw -b -bs -bc -br -brf -bcon -bdump -qr -q -qs --open --closed --merged -y --yank -u --user -h --help"
